...
INSTALLED_BOOTIMAGE_TARGET := $(LOCAL_PATH)/boot.img
...
recovery_uncompressed_device_ramdisk := $(LOCAL_PATH)/ramdisk-recovery-device.cpio
...
uncompressed_ramdisk := $(LOCAL_PATH)/ramdisk.cpio
